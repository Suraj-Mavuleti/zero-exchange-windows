...
class App(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Zero Exchange Console")
        ...
        # Branding
        self.logo_label = ctk.CTkLabel(self.sidebar, text="EXCHANGE", font=ctk.CTkFont("Segoe UI", size=26, weight="bold"), text_color=self.accent_color)
        ...
        self.header = ctk.CTkLabel(self.main_view, text="Zero Exchange Console", font=ctk.CTkFont("Segoe UI", size=32, weight="bold"), text_color=self.text_primary)
